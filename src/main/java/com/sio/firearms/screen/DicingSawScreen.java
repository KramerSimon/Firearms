...
public class DicingSawScreen extends AbstractContainerScreen<DicingSawMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/dicing_saw.png");

    public DicingSawScreen(DicingSawMenu menu, Inventory playerInventory, Component title) {
