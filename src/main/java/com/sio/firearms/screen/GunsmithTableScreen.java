...
public class GunsmithTableScreen extends AbstractContainerScreen<GunsmithTableMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/gunsmith_table.png");

    public GunsmithTableScreen(GunsmithTableMenu menu, Inventory playerInventory, Component title) {
