...
public class MetallizationChamberScreen extends AbstractContainerScreen<MetallizationChamberMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/metallization_chamber.png");

    public MetallizationChamberScreen(MetallizationChamberMenu menu, Inventory playerInventory, Component title) {
