...
public class IonImplanterScreen extends AbstractContainerScreen<IonImplanterMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/ion_implanter.png");

    public IonImplanterScreen(IonImplanterMenu menu, Inventory playerInventory, Component title) {
