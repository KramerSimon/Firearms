...
public class WaferTesterScreen extends AbstractContainerScreen<WaferTesterMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/wafer_tester.png");

    public WaferTesterScreen(WaferTesterMenu menu, Inventory playerInventory, Component title) {
