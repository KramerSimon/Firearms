...
public class CrystalGrowthControllerScreen extends AbstractContainerScreen<CrystalGrowthControllerMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/crystal_growth_controller.png");

    public CrystalGrowthControllerScreen(CrystalGrowthControllerMenu menu, Inventory playerInventory, Component title) {
