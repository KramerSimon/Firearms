...
public class DepositionChamberScreen extends AbstractContainerScreen<DepositionChamberMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/deposition_chamber.png");

    public DepositionChamberScreen(DepositionChamberMenu menu, Inventory playerInventory, Component title) {
