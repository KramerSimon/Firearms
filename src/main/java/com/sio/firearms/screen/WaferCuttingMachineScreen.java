...
public class WaferCuttingMachineScreen extends AbstractContainerScreen<WaferCuttingMachineMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("firearms", "textures/gui/wafer_cutting_machine.png");

    public WaferCuttingMachineScreen(WaferCuttingMachineMenu menu, Inventory playerInventory, Component title) {
