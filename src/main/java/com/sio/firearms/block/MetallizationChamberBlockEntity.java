...
public class MetallizationChamberBlockEntity extends EnergyStorageBlock implements MenuProvider {

    public static final int CAPACITY     = 45_000;
    public static final int MAX_RECEIVE  = 450;
    public static final int FE_PER_TICK  = 160;
    ...
    public MetallizationChamberBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.METALLIZATION_CHAMBER.get(), pos, state, CAPACITY, MAX_RECEIVE, 0);
    }

    public ItemStackHandler getInventory() { return inventory; }

    @Override public Component getDisplayName() { return Component.translatable("block.firearms.metallization_chamber"); }

    @Override public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) {
        return new MetallizationChamberMenu(id, inv, inventory, data);
    }
    ...
    public void serverTick() {
        ...
        ItemStack result = new ItemStack(ModItems.FINISHED_WAFER.get());

        boolean canProcess = stackIs(in0, "firearms:doped_wafer") && stackIs(in1, "minecraft:copper_ingot")
