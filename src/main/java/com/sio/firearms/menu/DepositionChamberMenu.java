...
public class DepositionChamberMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public DepositionChamberMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStackHandler(3), new SimpleContainerData(4));
    }

    public DepositionChamberMenu(int containerId, Inventory playerInventory, ItemStackHandler handler, ContainerData data) {
        super(ModMenuTypes.DEPOSITION_CHAMBER_MENU.get(), containerId);
        this.data = data;
