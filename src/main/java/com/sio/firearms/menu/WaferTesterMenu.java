...
public class WaferTesterMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public WaferTesterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStackHandler(2), new SimpleContainerData(4));
    }

    public WaferTesterMenu(int containerId, Inventory playerInventory, ItemStackHandler handler, ContainerData data) {
        super(ModMenuTypes.WAFER_TESTER_MENU.get(), containerId);
        this.data = data;
