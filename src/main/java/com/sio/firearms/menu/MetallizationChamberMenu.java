...
public class MetallizationChamberMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public MetallizationChamberMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStackHandler(3), new SimpleContainerData(4));
    }

    public MetallizationChamberMenu(int containerId, Inventory playerInventory, ItemStackHandler handler, ContainerData data) {
        super(ModMenuTypes.METALLIZATION_CHAMBER_MENU.get(), containerId);
        this.data = data;
