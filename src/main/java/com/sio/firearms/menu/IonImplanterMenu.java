...
public class IonImplanterMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public IonImplanterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStackHandler(3), new SimpleContainerData(4));
    }

    public IonImplanterMenu(int containerId, Inventory playerInventory, ItemStackHandler handler, ContainerData data) {
        super(ModMenuTypes.ION_IMPLANTER_MENU.get(), containerId);
        this.data = data;
