...
public class PlasmaEtcherMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public PlasmaEtcherMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStackHandler(2), new SimpleContainerData(6));
    }

    public PlasmaEtcherMenu(int containerId, Inventory playerInventory, ItemStackHandler handler, ContainerData data) {
        super(ModMenuTypes.PLASMA_ETCHER_MENU.get(), containerId);
        this.data = data;
    ...
    public int getFluidMax()     { return data.get(5); }
