...
public class DicingSawMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public DicingSawMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStackHandler(3), new SimpleContainerData(4));
    }

    public DicingSawMenu(int containerId, Inventory playerInventory, ItemStackHandler handler, ContainerData data) {
        super(ModMenuTypes.DICING_SAW_MENU.get(), containerId);
        this.data = data;
