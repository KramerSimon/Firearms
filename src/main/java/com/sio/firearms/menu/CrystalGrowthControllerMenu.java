...
public class CrystalGrowthControllerMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public CrystalGrowthControllerMenu(int containerId, Inventory playerInventory) {
    ...
    public CrystalGrowthControllerMenu(int containerId, Inventory playerInventory,
        ...
        super(ModMenuTypes.CRYSTAL_GROWTH_CONTROLLER_MENU.get(), containerId);
        this.data = data;
