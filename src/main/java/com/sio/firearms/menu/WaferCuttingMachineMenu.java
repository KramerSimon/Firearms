...
public class WaferCuttingMachineMenu extends AbstractContainerMenu {

    private final ContainerData data;

    public WaferCuttingMachineMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new ItemStackHandler(3), new SimpleContainerData(4));
    }

    public WaferCuttingMachineMenu(int containerId, Inventory playerInventory, ItemStackHandler handler, ContainerData data) {
        super(ModMenuTypes.WAFER_CUTTING_MACHINE_MENU.get(), containerId);
        this.data = data;
